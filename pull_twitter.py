...
if __name__ == "__main__":
    ...
    timeline_group.add_argument("-aic", "--author-id-column", type=str, help="Name of handles column in handles-csv")
    ...
    parser_timeline.add_argument("-usc", "--use-skip", type=bool, help="Indicates whether to use the skip column to "
                                                                       "ignore specific handles", required=False)
    ...
    users_group.add_argument("-aic", "--author-id-column", type=str, help="Name of handles column in handles-csv")
    parser_users.add_argument("-sc", "--skip-column", type=str,
                              help="Name of column containing skip indicators in handles-csv", required=False)
    parser_users.add_argument("-usc", "--use-skip", type=bool,
                              help="Indicates whether to use the skip column to ignore specific handles",
                              required=False)
    ...
    parser_search.add_argument("-mr", "--max-response", type=int, help="Maximum number of tweets to return using query",
                               required=False)
    parser_search.add_argument("-st", "--start-time", type=str,
                               help="Starting date to search tweets (in format YYYY-MM-DD or isoformat)",
                               required=False)
